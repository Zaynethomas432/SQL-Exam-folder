...
while menu_choice != 'Z':
    ...
    if menu_choice == 'F':
         ...
         print_parameter_query("graph_card, processor, cores, tmus, rops, mem_size_gb, bandwidth_gbs, clock_spd_mhz, boost_spd_mhz, fp32_tflops, price", "manufacturer = ? ORDER BY fp32_tflops ASC",company)  
